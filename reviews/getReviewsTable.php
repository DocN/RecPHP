...
$sql = "SELECT * FROM reviews LEFT OUTER JOIN instructors ON reviews.instructorID = instructors.instructorID LEFT OUTER JOIN classes ON reviews.classID = classes.classID";
